...
songs_data = [
    {
        ...
        "clip": "clips/song1_clip.mp3",
        "full": "fulls/song1_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song2_clip.mp3",
        "full": "fulls/song2_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song3_clip.mp3",
        "full": "fulls/song3_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song4_clip.mp3",
        "full": "fulls/song4_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song5_clip.mp3",
        "full": "fulls/song5_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song6_clip.mp3",
        "full": "fulls/song6_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song7_clip.mp3",
        "full": "fulls/song7_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song8_clip.mp3",
        "full": "fulls/song8_full.mp3",
    ...
    },
    {
        ...
        "clip": "clips/song9_clip.mp3",
        "full": "fulls/song9_full.mp3",
...
def show_chatting_page():
    ...
    if st.session_state.get('show_images', False):
        ...
        try:
            # 修改这里的路径为你的第一张图片路径
            st.image("special/image1.jpg", caption="双人版（即老师著作）", use_container_width=True)
        except FileNotFoundError:
        ...
        try:
            # 修改这里的路径为你的第二张图片路径
            st.image("special/image2.jpg", caption="三人版（即老师著作）", use_container_width=True)
        except FileNotFoundError:
        ...
        try:
            # 修改这里的路径为你的第三张图片路径
            st.image("special/image3.jpg", caption="（似乎是某天从某处归来时跑上楼拍的）", use_container_width=True)
        except FileNotFoundError:
